...
public class QueryEngine {
    ...
    public void AnalyzedAppQuery() throws IOException, CypherException {
        Result result;
    ...
    public void deleteQuery(String appKey) throws IOException, CypherException {
        Result result;
    ...
    public List<String> findKeysFromPackageName(String appName) throws IOException, CypherException {
    ...
    public void countVariables() throws IOException, CypherException {
        Result result;
        try (Transaction ignored = graphDatabaseService.beginTx()) {
    ...
    public void countInnerClasses() throws IOException, CypherException {
        Result result;
        try (Transaction ignored = graphDatabaseService.beginTx()) {
    ...
    public void countAsyncClasses() throws IOException, CypherException {
        Result result;
        try (Transaction ignored = graphDatabaseService.beginTx()) {
    ...
    public void countViews() throws IOException, CypherException {
        Result result;
        try (Transaction ignored = graphDatabaseService.beginTx()) {
    ...
    public void executeRequest(String request) throws IOException, CypherException {
        Result result;
        try (Transaction ignored = graphDatabaseService.beginTx()) {
            result = graphDatabaseService.execute(request);
